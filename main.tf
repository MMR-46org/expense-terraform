module "vpc" {
  ...
  public_subnets_cidr  =  lookup(each.value, "public_subnet_cidr", null)
  web_subnets_cidr     =  lookup(each.value, "web_subnet_cidr", null)
  app_subnets_cidr     =  lookup(each.value, "app_subnet_cidr", null)
  db_subnets_cidr      =  lookup(each.value, "db_subnet_cidr", null)
